#ifndef FADDEEVAS_CERNLIB_REV5_C_H__
#define FADDEEVAS_CERNLIB_REV5_C_H__
    ...
    #include "cernlib_rev5_c/definitions.h"
...
CERRF_STATIC CERRF_FN void cerrf_rev5(
...
CERRF_STATIC CERRF_FN int wofz_cernlib_rev5(
    CERRF_REAL_TYPE x, CERRF_REAL_TYPE y,
    CERRF_RESULT_DEC CERRF_REAL_TYPE* CERRF_RESTRICT out_x,
    CERRF_RESULT_DEC CERRF_REAL_TYPE* CERRF_RESTRICT out_y ) CERRF_NOEXCEPT;
...
CERRF_EXTERN void cerrf_rev5_ext(
...
void cerrf_rev5( CERRF_REAL_TYPE x, CERRF_REAL_TYPE y,
    CERRF_RESULT_DEC CERRF_REAL_TYPE* CERRF_RESTRICT out_x,
    CERRF_RESULT_DEC CERRF_REAL_TYPE* CERRF_RESTRICT out_y ) CERRF_NOEXCEPT
{
...
CERRF_INLINE int wofz_cernlib_rev5(
    CERRF_REAL_TYPE x, CERRF_REAL_TYPE y,
    CERRF_RESULT_DEC CERRF_REAL_TYPE* CERRF_RESTRICT out_x,
    CERRF_RESULT_DEC CERRF_REAL_TYPE* CERRF_RESTRICT out_y ) CERRF_NOEXCEPT
{
    cerrf_rev5( x, y, out_x, out_y );
    return 0;
}
...
#endif /* defined( __cplusplus ) */
#endif /* FADDEEVAS_CERNLIB_REV5_C_H__ */
