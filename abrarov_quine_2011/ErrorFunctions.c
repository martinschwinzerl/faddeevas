...
real_type const CERRF_FOURIER_COEFF[ CERRF_N_FOURIER ] = {
...
real_type const CERRF_TAYLOR_COEFF[ CERRF_NUM_TAYLOR_COEFF ] = {
    /* =======  pole nn =  0 ====== */
...
void cerf_abrarov_quine_ext( real_type in_x, real_type in_y,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_x,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_y ) CERRF_NOEXCEPT
{
    cerf_abrarov_quine( in_x, in_y, out_x, out_y, &CERRF_FOURIER_COEFF[ 0 ],
        &CERRF_TAYLOR_COEFF[ 0 ] );
}

void cerfc_abrarov_quine_ext( real_type in_x, real_type in_y,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_x,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_y ) CERRF_NOEXCEPT
{
    cerf_abrarov_quine( in_x, in_y, out_x, out_y, &CERRF_FOURIER_COEFF[ 0 ],
...
int wofz_abrarov_quine_ext( real_type in_x, real_type in_y,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_x,
    CERRF_RESULT_DEC real_type* CERRF_RESTRICT out_y ) CERRF_NOEXCEPT
{
